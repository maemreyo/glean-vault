...
> **Etymology:** From Old French "trial", from "trier" (to try, pick out), from Latin "triare" (to separate, sift)
...
> - Can describe difficult life experiences
...
> **1. Trial vs Trail**
> - ❌ **Mistake:** "We followed the trial through the forest."
> - ✅ **Correction:** "We followed the trail through the forest."
> - **Why:** Trial = test/court case; Trail = path

> [!tip] Learning Notes
> - **Memory Hook:** Trial = "try" + "-al" → an occasion to try/test
> - **Visual Association:** Picture a courtroom with judge and jury
> - **Story/Situation:** Scientists testing different solutions until finding one that works (trial and error)
