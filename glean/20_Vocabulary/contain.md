...
> **Etymology:** From Old French "contenir" (to contain), from Latin "continere" (to hold together), from "com-" (together) + "tenere" (to hold)
...
> - Abstract containment (book contains information)
...
> **1. Preposition Error**
> - ❌ **Mistake:** The box contains *of* five items.
> - ✅ **Correction:** The box contains five items. / The box consists *of* five items.
> - **Why:** "Contain" is a transitive verb and doesn't need a preposition. "Consist of" requires "of".

> [!tip] Learning Notes
> - **Memory Hook:** Think of "con-" (together) + "tain" (hold) = holding things together inside
> - **Visual Association:** Picture a container (like a box) holding various items together
> - **Story/Situation:** A scientist tries to contain a dangerous chemical in a special container to prevent it from escaping

> [!quote]- Context Source
> **Quote:** "The meeting room contained a diverse group of professionals from various industries."
