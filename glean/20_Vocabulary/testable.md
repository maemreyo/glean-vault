...
> **Etymology:** From "test" + "-able" (suffix meaning capable of), from Latin "testari" (to bear witness)
...
> - Can refer to theories that can be proven false
...
> **1. Testable vs Tested**
> - ❌ **Mistake:** "The feature is testable" (meaning it has been tested)
> - ✅ **Correction:** "The feature is tested" (meaning it has been tested)
> - **Why:** Testable = can be tested; Tested = has been tested

> [!tip] Learning Notes
> - **Memory Hook:** Testable = "test" + "able" → able to be tested
> - **Visual Association:** Picture a scientist with lab equipment testing a hypothesis
> - **Story/Situation:** A developer writing code with clear inputs and outputs that can be easily tested
