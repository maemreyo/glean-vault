...
> **Etymology:** From Latin "excludere" (to shut out), from "ex" (out) + "claudere" (to shut, close)
...
> - Can refer to people, items, or possibilities
...
> **1. Exclude vs Except**
> - ❌ **Mistake:** "Everyone exclude Sarah is coming to the party."
> - ✅ **Correction:** "Everyone except Sarah is coming to the party."
> - **Why:** Exclude = remove deliberately; Except = not including

> [!tip] Learning Notes
> - **Memory Hook:** Exclude = "ex" (out) + "clude" (close) → close out
> - **Visual Association:** Picture a bouncer at a club excluding someone from entry
> - **Story/Situation:** A filter removing unwanted elements from a search result
