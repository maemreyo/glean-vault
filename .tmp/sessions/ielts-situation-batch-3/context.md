# Task Context: IELTS Situation Flashcard Processing - Batch 3

Session ID: ielts-situation-batch-3
Created: 2025-12-25
Status: in_progress
...
## Files to Process (Batch 3)
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/Which event requires the largest number of volunteers? The music festival, the science festival, the book festival.md` - multi-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is encouraging cooperation between local organisations.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is giving advice to visitors.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is helping people find their seats.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is introducing guest speakers at an event.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is providing entertainment.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is providing publicity about a council service.md` - single-option
- `/Users/trung.ngo/Documents/zaob-dev/glean-vault/glean/40_Situation/the role of the volunteers is selling tickets.md` - single-option
...
- [ ] Process file 1: Which event requires the largest number... (multi-option)
- [ ] Process file 2: the role of the volunteers is encouraging cooperation...
- [ ] Process file 3: the role of the volunteers is giving advice...
- [ ] Process file 4: the role of the volunteers is helping people...
- [ ] Process file 5: the role of the volunteers is introducing guest...
- [ ] Process file 6: the role of the volunteers is providing entertainment...
- [ ] Process file 7: the role of the volunteers is providing publicity...
- [ ] Process file 8: the role of the volunteers is selling tickets...
...
Example: For volunteer/event content → PILLAR: social-leisure, subtopic: volunteering
...
IMPORTANT: These files are from IELTS Listening Section 1-2 context. The volunteer/event files relate to festival/event volunteering. Use appropriate context in your analysis. Focus on practical, event-related tasks and responsibilities.
